...
- **五独立逐项判断**：资产、人员、财务、机构、业务独立必须分别引用底稿和其他 DD Memo，不得合并笼统结论。
- **资金与账户核查**：重点核查资金占用、共用账户、代收代付、关联方垫款和财务人员兼职。
- **业务依赖识别**：关联采购销售、共用渠道、共用品牌技术、客户供应商重合需判断是否削弱独立经营能力。
- **高风险触发器**：重大资金占用未解决、核心资产归属关联方、人员/财务混同、独立获客能力不足，应列高风险。
