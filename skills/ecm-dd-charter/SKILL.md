...
- **现行章程锁定**：必须确认使用经有效审议并完成备案/披露的最新版章程，不得混用历史版本。
- **公司法衔接**：重点核查股东会、董事会、审计委员会/监事会、法定代表人、出资期限和利润分配条款。
- **上市规则衔接**：拟上市或上市公司需核对章程指引、股东会规则、交易所规范运作和独董/专委会要求。
- **高风险触发器**：章程与法律强制规定冲突、反收购/特殊表决权安排未披露、三会议事规则缺失，应列高风险。
