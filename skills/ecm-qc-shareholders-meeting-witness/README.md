...
└── references/
    ...
    ├── voting-rules.md              # 三种特殊表决方式专项（特别决议 /
    │                                # 累积投票 / 中小投资者单独计票
    │                                # 法规依据 + 议案识别 + 强校验矩阵）
    ├── form-requirements.md         # 形式要件 14 项清单
    ├── substantive-checklist.md     # 实质审查 8 类要点
    ├── common-errors.md             # 9 类常见错误模式库（含新增高危项）
    └── comment-templates.md         # 批注标准话术模板（含三类表决方式专项）
```
...
- 《公司法》（2023 年修订，2024 年 7 月施行）—— 特别决议（第 116 条）、
  累积投票制（第 119 条）的法律基础
- 《上市公司股东会规则》（2025 年修订）—— 特别决议事项（第 35 条）、
  累积投票（第 36 条）、中小投资者单独计票（第 31 条）
- 《上市公司治理准则》（证监会公告〔2018〕第 29 号）—— 累积投票制
  强制适用情形（第 26 条）
